...
**在安装SuperClaude V4之前，请阅读此内容。**

混合使用不同的安装方法（`pip`、`npm`、`pipx`、旧版插件）可能会导致命令冲突并损坏您的设置，从而引发**意外错误**。

为确保安全和干净的安装，我们**强烈建议**使用官方清理脚本来移除所有现有的SuperClaude安装。
...
2.  **运行脚本：**
    ...
    ```
    该脚本将扫描您的系统，并指导您安全地备份和删除所有检测到的与SuperClaude相关的文件。

清理完成后，您可以继续进行V4的干净安装。
