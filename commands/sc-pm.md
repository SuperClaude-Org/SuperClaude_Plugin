...
plan/:
  plan/[feature]/sc:hypothesis     # Plan phase: 仮説・設計
  plan/[feature]/sc:architecture   # Architecture decisions
  plan/[feature]/sc:rationale      # Why this approach chosen

execution/:
  execution/[feature]/sc:do        # Do phase: 実験・試行錯誤
  execution/[feature]/sc:errors    # Error log with timestamps
  execution/[feature]/sc:solutions # Solution attempts log

evaluation/:
  evaluation/[feature]/sc:check    # Check phase: 評価・分析
  evaluation/[feature]/sc:metrics  # Quality metrics (coverage, performance)
  evaluation/[feature]/sc:lessons  # What worked, what failed
